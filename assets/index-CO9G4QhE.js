 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const OS=Oe.forwardRef(({color:r="currentColor",size:t=24,strokeWidth:i=2,absoluteStrokeWidth:s,className:l="",children:c,iconNode:h,...d},m)=>Oe.createElement("svg",{ref:m,...NS,width:t,height:t,stroke:r,strokeWidth:s?Number(i)*24/Number(t):i,className:B0("lucide",l),...!c&&!LS(d)&&{"aria-hidden":"true"},...d},[...h.map(([p,g])=>Oe.createElement(p,g)),...Array.isArray(c)?c:[c]]));/**
 * @license lucide-react v0.525.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Td=(r,t)=>{const i=Oe.forwardRef(({className:s,...l},c)=>Oe.createElement(OS,{ref:c,iconNode:t,className:B0(`lucide-${DS(M_(r))}`,`lucide-${r}`,s),...l}));return i.displayName=M_(r),i};/**
 * @license lucide-react v0.525.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
#define LOW_PRECISION`),t}function w1(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===F0?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===jS?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===oa&&(t="SHADOWMAP_TYPE_VSM"),t}function C1(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Rr:case wr:t="ENVMAP_TYPE_CUBE";break;case kc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function D1(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case wr:t="ENVMAP_MODE_REFRACTION";break}return t}function U1(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Ad:t="ENVMAP_BLENDING_MULTIPLY";break;case dy:t="ENVMAP_BLENDING_MIX";break;case py:t="ENVMAP_BLENDING_ADD";break}return t}function L1(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,s=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:s,maxMip:i}}function N1(r,t,i,s){const l=r.getContext(),c=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=w1(i),p=C1(i),g=D1(i),_=U1(i),x=L1(i),y=S1(i),E=y1(c),T=l.createProgram();let S,v,O=i.glslVersion?"#version "+i.glslVersion+`
